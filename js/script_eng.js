$(document).ready(function () { // вся магия после загрузки страницы
    ...
    $('.count_wrap').countdown('2014/12/31 23:55:55').on('update.countdown', function (event) {
        ...
        + '<div class="count_day_wrap"><div class="count">%-D</div><div class="inf">days</div></div><div class="dv">:</div>'
        + '<div class="count_hour_wrap"><div class="count">%-H</div><div class="inf">hours</div></div><div class="dv">:</div>'
        + '<div class="count_minute_wrap"><div class="count">%M</div><div class="inf">minutes</div></div><div class="dv">:</div>'
        + '<div class="count_second_wrap"><div class="count">%S</div><div class="inf">seconds</div></div><div class="org"></div></div>'));
    });
