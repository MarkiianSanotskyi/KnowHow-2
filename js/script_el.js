$(document).ready(function () { // вся магия после загрузки страницы
   ...
   $('.modal1_open').click(function (event) { // ловим клик по ссылки с id="go"
    ...
    $('.count_wrap').countdown('2014/12/31 23:55:55').on('update.countdown', function (event) {
        var $this = $(this).html(event.strftime('<div class="container"><div class="ost"></div>'
        + '<div class="count_day_wrap"><div class="count">%-D</div><div class="inf">ημέρες</div></div><div class="dv">:</div>'
        + '<div class="count_hour_wrap"><div class="count">%-H</div><div class="inf">ώρες</div></div><div class="dv">:</div>'
        + '<div class="count_minute_wrap"><div class="count">%M</div><div class="inf">πρακτικά</div></div><div class="dv">:</div>'
        + '<div class="count_second_wrap"><div class="count">%S</div><div class="inf">δευτερόλεπτα</div></div><div class="org"></div></div>'));
    });
